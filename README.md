...
Alternatively, if you use [Bases](https://help.obsidian.md/bases) (Obsidian's built-in database feature, requires v1.9+) instead of (or alongside) Dataview, the equivalent `.base` file looks like this:
